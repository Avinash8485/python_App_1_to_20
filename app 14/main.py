...
class DataBaseConnection:
    def __init__(self,host="localhost",user="root",password="book",database="python_school"):
        self.host = host
        self.user = user
...
class MainWindow(QMainWindow):
    ...
    def load_data(self):
        conect = DataBaseConnection().connect()
...
class DeleteDialog(QDialog):
    ...
    def delete_student(self):
        ...
        conect = DataBaseConnection().connect()
        cursor = conect.cursor()
        cursor.execute("DELETE FROM students where id = %s",(id_num,))
